/*
  # Complete LuckyPick Database Schema with Email OTP Verification

  1. New Tables
    - `email_verifications` - OTP verification system for email confirmation
    - `users` - User accounts with email verification status
    - `sessions` - Lottery draw sessions
    - `bets` - User bets on lottery numbers
  ...
  2. Security
    ...
    - Public access for signup/verification flow
